...
/*!******************************!*\
  !*** ./src/actions/index.js ***!
  \******************************/
/*! exports provided: getUsernames, getStatsByUsername, getProfileByUsername, getMatchesByUid, getProfileByUid, getNews */
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 5:
            ...
            uid = response.data.uid; // // Get Matches

            results = [];
            endPoint = "/users/public/matches_v2?user_id=".concat(uid);
            responseMatches = axiosInstance.get(endPoint); // // Get Stats

            endPoint = "/users/public/br_stats?user_id=".concat(uid, "&platform=").concat(platform, "&window=").concat(window);
            responseStats = axiosInstance.get(endPoint);
            _context3.next = 14;
            return _babel_runtime_corejs2_core_js_promise__WEBPACK_IMPORTED_MODULE_0___default.a.all(responseMatches, responseStats);

          case 14:
            results = _context3.sent;
            return _context3.abrupt("return", uid);
...
function () {
  ...
  /*#__PURE__*/
  _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.mark(function _callee5(uid) {
    var platform,
        window,
        endPoint,
        response,
  ...
  return function getProfileByUid(_x5) {
...
//# sourceMappingURL=leaderboard.js.7830c76bd3e9fca88694.hot-update.js.map