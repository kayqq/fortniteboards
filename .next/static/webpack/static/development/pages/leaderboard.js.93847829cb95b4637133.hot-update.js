...
/*!******************************!*\
  !*** ./src/actions/index.js ***!
  \******************************/
/*! exports provided: getUsernames, getStatsByUsername, getProfileByUsername, getProfileByUid, getNews */
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 5:
            ...
            uid = response.data.uid;
            results = []; // // Get Matches
            // endPoint = `/users/public/matches_v2?user_id=${uid}`;
            // const responseMatches = axiosInstance.get(endPoint);
            // // // Get Stats
            // endPoint = `/users/public/br_stats?user_id=${uid}&platform=${platform}&window=${window}`;
            // const responseStats = axiosInstance.get(endPoint);
...
function () {
  ...
  return function getStatsByUid(_x5) {
...
function () {
  ...
  return function getProfileByUid(_x6) {
...
//# sourceMappingURL=leaderboard.js.93847829cb95b4637133.hot-update.js.map