...
/*!******************************!*\
  !*** ./src/actions/index.js ***!
  \******************************/
/*! exports provided: getUsernames, getStatsByUsername, getProfileByUsername, getProfileByUid, getNews, getMatchesByUid, getStatsByUid, getHello */
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getHello", function() { return getHello; });
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 5:
            ...
            console.log('calling both gets');
            _context3.next = 13;
            return _babel_runtime_corejs2_core_js_promise__WEBPACK_IMPORTED_MODULE_0___default.a.all([responseStats, responseMatches, x]);

          case 13:
            response = _context3.sent;
            console.log('both gets got');
            profile = {
              profile: response[0],
              matches: response[1]
            };
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            response = axiosInstance.get(endPoint);
...
var getHello = function getHello(dataobj) {
...
//# sourceMappingURL=leaderboard.js.9d12d5d2efb2164ad9d8.hot-update.js.map