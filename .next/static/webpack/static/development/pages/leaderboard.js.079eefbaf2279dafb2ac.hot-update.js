...
/* harmony import */ var _src_components_SearchBar__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../src/components/SearchBar */ "./src/components/SearchBar.js");
/* harmony import */ var _src_actions__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../src/actions */ "./src/actions/index.js");
/* harmony import */ var _src_components_board__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ../src/components/board */ "./src/components/board/index.js");
...
function (_Component) {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 5:
                ...
                _context.next = 8;
                return Object(_src_actions__WEBPACK_IMPORTED_MODULE_18__["getProfile"])(usernames);
              ...
              case 11:
                _context.next = 13;
                return _babel_runtime_corejs2_core_js_promise__WEBPACK_IMPORTED_MODULE_3___default.a.all(usernames.map(function (username) {
                  return Object(_src_actions__WEBPACK_IMPORTED_MODULE_18__["getProfile"])(username);
                }));
  ...
  function Leaderboard(props) {
      ...
      return function () {
        ...
        if (column !== accessor) {
          if (accessor == 'username') {
            sortedPlayers = (Object(_babel_runtime_corejs2_helpers_esm_readOnlyError__WEBPACK_IMPORTED_MODULE_1__["default"])("sortedPlayers"), lodash__WEBPACK_IMPORTED_MODULE_15___default.a.sortBy(players, function (o) {
              return o.stats["".concat(accessor, "_").concat(mode)];
            }));
          } else {
            sortedPlayers = (Object(_babel_runtime_corejs2_helpers_esm_readOnlyError__WEBPACK_IMPORTED_MODULE_1__["default"])("sortedPlayers"), lodash__WEBPACK_IMPORTED_MODULE_15___default.a.sortBy(_this.state.players, function (o) {
              return o.username;
            }));
          }
          ...
          _this.setState({
            column: accessor,
            players: lodash__WEBPACK_IMPORTED_MODULE_15___default.a.sortBy(players, function (o) {
              return o.stats["".concat(accessor, "_").concat(mode)];
            }),
            direction: 'ascending'
          }, function () {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_11__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_10__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_10__["default"])(_this)), "sortPlayers", function (columnHeader) {
      _this.setState({
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_11__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_10__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_10__["default"])(_this)), "isPlayerSelected", function (username) {
      var players = _this.state.players;
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_8__["default"])(Leaderboard, [{
      ...
      this.setState({
        columns: [{
          ...
          sort: this.handleSort(function () {
            return lodash__WEBPACK_IMPORTED_MODULE_15___default.a.sortBy(_this2.state.players, function (o) {
              return o.username;
            });
          }, 'username')
        }, {
    ...
    value: function render() {
      ...
      var debouncedfetchByUsername = lodash__WEBPACK_IMPORTED_MODULE_15___default.a.debounce(fetchByUsername, 500, {
        maxWait: 1000
      });

      return react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_16__["Container"], {
        text: true,
        textAlign: "center",
        style: {
          paddingTop: '200px',
      ...
      }, react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement("h1", null, "Board"), react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_16__["Grid"], {
        columns: "1",
        centered: true,
        textAlign: "center"
      }, react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_16__["Grid"].Column, {
        mobile: "16",
        computer: "6",
        largeScreen: "6",
        tablet: "6",
        widescreen: "6"
      }, react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_16__["Container"], null, react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement(_src_components_SearchBar__WEBPACK_IMPORTED_MODULE_17__["default"], {
        ...
        textAlign: "center"
      }, react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement(_src_components_board__WEBPACK_IMPORTED_MODULE_19__["default"], {
        columns: columns,
        ...
        textAlign: "center"
      }, react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_16__["Table"], {
        sortable: true,
        unstackable: true,
        compact: true,
        size: "small",
      ...
      }, react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_16__["Table"].Header, null, react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_16__["Table"].Row, null, react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_16__["Table"].HeaderCell, {
        textAlign: "center",
        style: {
          backgroundColor: '#2c3c57',
          color: 'white'
        }
      }, react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_16__["Header"], {
        size: "tiny"
      }, react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_16__["Header"].Subheader, {
        as: "h6",
        style: {
          color: '#92a2bd'
        }
      }, "#")), ' '), react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_16__["Table"].HeaderCell, {
        style: {
          backgroundColor: '#2c3c57',
          color: 'white'
        ...
        onClick: this.handleSort(function () {
          return lodash__WEBPACK_IMPORTED_MODULE_15___default.a.sortBy(players, function (o) {
            return o.username;
          });
        }, 'username')
      }, react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_16__["Header"], {
      ...
      }, "Player"))), react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_16__["Table"].HeaderCell, {
        textAlign: "center",
        style: {
          backgroundColor: '#2c3c57',
          color: 'white'
      ...
      }, "K/D"))), react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_16__["Table"].HeaderCell, {
        textAlign: "center",
        style: {
          backgroundColor: '#2c3c57',
          color: 'white'
      ...
      }, "Win %"))), react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_16__["Table"].HeaderCell, {
        textAlign: "center",
        style: {
          backgroundColor: '#2c3c57',
          color: 'white'
      ...
      }, "Kills"))), react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_16__["Table"].HeaderCell, {
        textAlign: "center",
        style: {
          backgroundColor: '#2c3c57',
          color: 'white'
      ...
      }, "Wins"))))), react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_16__["Table"].Body, null, lodash__WEBPACK_IMPORTED_MODULE_15___default.a.map(players, function (player, index) {
        return react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_16__["Table"].Row, {
          key: player.username,
          verticalAlign: "top"
        }, react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_16__["Table"].Cell, null, react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_16__["Header"], {
          as: "h6",
          style: {
            color: '#92a2bd'
          }
        }, index + 1)), react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_16__["Table"].Cell, {
          singleLine: true
        }, react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_16__["Header"], {
          as: "h6",
          style: {
        ...
        }, player.username, react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_16__["Header"].Subheader, {
          size: "small",
          style: {
            color: '#92a2bd'
          }
        }, player.stats["matchesplayed_".concat(mode)], ' ', "Matches"))), react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_16__["Table"].Cell, {
          singleLine: true,
          textAlign: "center"
        }, react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_16__["Header"], {
          as: "h4",
        ...
        }, player.stats["kd_".concat(mode)])), react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_16__["Table"].Cell, {
          singleLine: true,
          textAlign: "center"
        }, react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_16__["Header"], {
          as: "h4",
        ...
        }, player.stats["winrate_".concat(mode)])), react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_16__["Table"].Cell, {
          singleLine: true,
          textAlign: "center"
        }, react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_16__["Header"], {
          as: "h4",
        ...
        }, player.stats["kills_".concat(mode)])), react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_16__["Table"].Cell, {
          collapsing: true,
          singleLine: true,
          textAlign: "center"
        }, react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_16__["Header"], {
        ...
        }, player.stats["placetop1_".concat(mode)])), react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_16__["Table"].Cell, {
          singleLine: true,
          textAlign: "center",
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return Object(redux__WEBPACK_IMPORTED_MODULE_13__["bindActionCreators"])({
    fetchByUsername: _src_actions__WEBPACK_IMPORTED_MODULE_18__["fetchByUsername"]
  }, dispatch);
};

/* harmony default export */ __webpack_exports__["default"] = (Object(react_redux__WEBPACK_IMPORTED_MODULE_14__["connect"])(mapStateToProps, mapDispatchToProps)(Leaderboard));

/***/ })

})
//# sourceMappingURL=leaderboard.js.079eefbaf2279dafb2ac.hot-update.js.map