...
var SearchBar = function SearchBar(_ref2) {
  ...
  var debouncedSearchTerm = useDebounce(searchTerm, 500); // const fetchData = async () => {
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 2:
              ...
              console.log(response, formattedResults);
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_4__["useEffect"])(function () {
    if (debouncedSearchTerm) {
      setIsSearching(true);
      setResults(fetch());
      setIsSearching(false); // const results = await getUsernames(debouncedSearchTerm);
  ...
  function () {
    ...
    /*#__PURE__*/
    _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(e, _ref4) {
      var value;
...
//# sourceMappingURL=leaderboard.js.694ac1aaf8fc7e4c2389.hot-update.js.map