    ...
    value: function componentDidMount() {
      ...
      this.setState({
        columns: [{
          ...
          accessor: 'username',
          size: '5',
          sortFn: this.handleSort(function () {
          ...
          sortFn: this.handleSort(function () {
            return lodash__WEBPACK_IMPORTED_MODULE_14___default.a.sortBy(players, function (o) {
              return o.stats["wins_".concat(mode)];
            });
          }, 'wins')
        }, {
          header: 'Wins',
          ...
          }, 'username') // { header: 'Matches', accessor: 'matchesplayed', size: '3' }
...
//# sourceMappingURL=leaderboard.js.680f919c518b17fc8a27.hot-update.js.map