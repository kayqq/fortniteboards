  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_7__["default"])(Leaderboard, null, [{
    ...
    value: function () {
      ...
      _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.mark(function _callee(_ref) {
        var store, query, pathname, asPath, req, usernames, initialPlayers, entries, names;
        return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 5:
                entries = typeof usernames == 'string' ? 1 : usernames.length;
              ...
              case 16:
                names = typeof usernames == 'string' ? [usernames] : usernames;
                console.log(names); // const init =
                //     typeof usernames == 'string'
                //         ? [await getProfile(usernames)]
                //         : await Promise.all(usernames.map(username => getProfile(username)));
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 3:
                ...
                updatedPlayers = [].concat(Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__["default"])(players), [newPlayer]); // if sorted then sort with added player
...
//# sourceMappingURL=leaderboard.js.699f4c9476c591531b37.hot-update.js.map