...
function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_7__["default"])(Leaderboard, [{
    ...
    value: function componentDidMount() {
      var queriedPlayers = this.props.players;
      var entries = this.props.entries;
      var players = this.state.players; // this.setState({
      //     players: [...players, entries <= 1 ? queriedPlayers : ...this],
      //     entries: entries
      // });

      if (entries <= 1) {
        this.setState({
          players: [].concat(Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__["default"])(players), [queriedPlayers]),
          entries: entries
        });
      } else {
        this.setState({
          players: [].concat(Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__["default"])(players), Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__["default"])(queriedPlayers)),
          entries: entries
        });
      }
    }
...
//# sourceMappingURL=leaderboard.js.d074bfe3191de0143e84.hot-update.js.map