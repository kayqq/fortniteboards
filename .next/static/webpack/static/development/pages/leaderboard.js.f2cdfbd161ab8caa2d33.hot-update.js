      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 5:
            ...
            // Await till all requests are done
            // const profile = { matches: await responseMatches, profile: await responseStats };

            profile = {
              profile: getStatsByUid(uid),
              matches: getMatchesByUid(uid)
            };
            _context3.next = 10;
            return profile;
...
//# sourceMappingURL=leaderboard.js.f2cdfbd161ab8caa2d33.hot-update.js.map