      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 5:
            ...
            responseMatches = axiosInstance.get(endPoint);
            console.log('responseMatches', responseMatches); // // Get Stats
            // endPoint = `/users/public/br_stats?user_id=${uid}&platform=${platform}&window=${window}`;
            // const responseStats = axiosInstance.get(endPoint);
            // results = await Promise.all(responseMatches, responseStats);
...
//# sourceMappingURL=leaderboard.js.64b777ba48e8c43f9239.hot-update.js.map