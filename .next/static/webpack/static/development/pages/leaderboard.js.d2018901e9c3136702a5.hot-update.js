      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 5:
            ...
            uid = response.data.uid; // const responseMatches = getMatchesByUid(uid);
            // const responseStats = getStatsByUid(uid);
            // // response = await Promise.all([responseStats, responseMatches]);
...
function () {
  ...
  /*#__PURE__*/
  _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee7(uid) {
    var platform,
        window,
        endPoint,
        response,
...
//# sourceMappingURL=leaderboard.js.d2018901e9c3136702a5.hot-update.js.map